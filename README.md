...
Edit your `app/Http/Kernel.php` by adding `\Acidwave\LaravelSSO\Middleware\SSOAutoLogin::class` middleware to `web` middleware group. It should look like this:
```php
protected $middlewareGroups = [
        'web' => [
            ...
            \Acidwave\LaravelSSO\Middleware\SSOAutoLogin::class,
        ],
...
{
    $broker = new \Acidwave\LaravelSSO\LaravelSSOBroker;
